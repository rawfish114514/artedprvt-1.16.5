...
public class ScriptProcess {
    ...
    protected CommandSource sender;//用户
    ...
    public ScriptProcess(CommandSource senderIn, String commandNameIn, String dirIn, List<String> sargsIn, String packIn, List<String> argsIn) throws CommandException {
        sender=senderIn;
        ...
        if(getValueS()){
            ...
            Minecraft.getInstance().getConnection().getConnection().send(new CChatMessagePacket(sb.toString()));
            ret=11;//进程失效
            return;
        }
        ret=0;//进程创建 无效退出
